...
def draw(canvas):
    ...
    if ball_pos[0] <= BALL_RADIUS + PAD_WIDTH:
        ...
        ball_vel[1] = - ball_vel[1]
    # draw paddles
    canvas.draw_line([0,paddle1_pos - HALF_PAD_HEIGHT],[0,paddle1_pos + HALF_PAD_HEIGHT ], 15, "White")
    canvas.draw_line([WIDTH,paddle2_pos - HALF_PAD_HEIGHT],[WIDTH,paddle2_pos + HALF_PAD_HEIGHT ], 15, "White")
    canvas.draw_line([WIDTH,paddle2_pos - HALF_PAD_HEIGHT],[WIDTH,paddle2_pos + HALF_PAD_HEIGHT ], 15, "White")
    
    # draw scores
    canvas.draw_text(str(score1), [WIDTH/4,75], 50, "Red")
    canvas.draw_text(str(score2), [WIDTH*3/4,75], 50, "Red")
